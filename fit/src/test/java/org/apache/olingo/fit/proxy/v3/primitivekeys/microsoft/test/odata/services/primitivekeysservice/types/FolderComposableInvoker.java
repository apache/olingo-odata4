...
public interface FolderComposableInvoker 
  extends org.apache.olingo.ext.proxy.api.StructuredComposableInvoker<Folder, Folder.Operations>
   {

  @Override
  FolderComposableInvoker select(String... select);

  @Override
  FolderComposableInvoker expand(String... expand);

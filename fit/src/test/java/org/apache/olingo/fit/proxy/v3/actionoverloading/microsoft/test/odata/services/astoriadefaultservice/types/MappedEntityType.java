...
public interface MappedEntityType
  ...
  @org.apache.olingo.ext.proxy.api.annotations.Property(name = "BagOfComplexToCategories",
      ...
      fcNSURI = "",
      fcKeepInContent = false)
      java.util.Collection<org.apache.olingo.fit.proxy.v3.actionoverloading.microsoft.test.odata.services.astoriadefaultservice.types.ComplexToCategory>
      getBagOfComplexToCategories();

      void
      setBagOfComplexToCategories(
          java.util.Collection<org.apache.olingo.fit.proxy.v3.actionoverloading.microsoft.test.odata.services.astoriadefaultservice.types.ComplexToCategory> _bagOfComplexToCategories);
  ...
  org.apache.olingo.fit.proxy.v3.actionoverloading.microsoft.test.odata.services.astoriadefaultservice.types.Phone
      ...
      void
      setComplexPhone(
          org.apache.olingo.fit.proxy.v3.actionoverloading.microsoft.test.odata.services.astoriadefaultservice.types.Phone _complexPhone);
  ...
  @org.apache.olingo.ext.proxy.api.annotations.Property(name = "ComplexContactDetails",
      ...
      getComplexContactDetails();

      void
      setComplexContactDetails(
          org.apache.olingo.fit.proxy.v3.actionoverloading.microsoft.test.odata.services.astoriadefaultservice.types.ContactDetails _complexContactDetails);

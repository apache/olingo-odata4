...
public interface LastLoginComposableInvoker 
  extends org.apache.olingo.ext.proxy.api.StructuredComposableInvoker<LastLogin, LastLogin.Operations>
   {

  @Override
  LastLoginComposableInvoker select(String... select);

  @Override
  LastLoginComposableInvoker expand(String... expand);

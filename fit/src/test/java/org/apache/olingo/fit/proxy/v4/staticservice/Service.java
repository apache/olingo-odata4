...
public class Service<C extends CommonEdmEnabledODataClient<?>> extends AbstractService<C> {
  ...
  public Service(final String compressedMetadata, final String metadataETag,
    ...
    complexTypes.put("Microsoft.Test.OData.Services.ODataWCFService.HomeAddress", org.apache.olingo.fit.proxy.v4.staticservice.microsoft.test.odata.services.odatawcfservice.types.HomeAddress.class);
    enumTypes.put("Microsoft.Test.OData.Services.ODataWCFService.AccessLevel", org.apache.olingo.fit.proxy.v4.staticservice.microsoft.test.odata.services.odatawcfservice.types.AccessLevel.class);
    enumTypes.put("Microsoft.Test.OData.Services.ODataWCFService.Color", org.apache.olingo.fit.proxy.v4.staticservice.microsoft.test.odata.services.odatawcfservice.types.Color.class);
    enumTypes.put("Microsoft.Test.OData.Services.ODataWCFService.CompanyCategory", org.apache.olingo.fit.proxy.v4.staticservice.microsoft.test.odata.services.odatawcfservice.types.CompanyCategory.class);
    terms.put("Microsoft.Test.OData.Services.ODataWCFService.IsBoss", org.apache.olingo.fit.proxy.v4.staticservice.microsoft.test.odata.services.odatawcfservice.types.IsBoss.class);
    //CHECKSTYLE:ON (Maven checkstyle)
  }

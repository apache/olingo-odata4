...
public class ServiceDocumentResponse extends ServiceResponse {
  ...
  public static ServiceDocumentResponse getInstace(ServiceRequest request, ODataResponse respose,
    ...
    return new ServiceDocumentResponse(respose, request.getSerializer(), responseContentType);
  }

  private ServiceDocumentResponse(ODataResponse respose, ODataSerializer serializer,
  ...
  public void writeServiceDocument(ServiceMetadata metadata, String serviceRoot)
      throws ODataTranslatedException {
    assert (!isClosed());
    this.response.setContent(this.serializer.serviceDocument(metadata.getEdm(), serviceRoot));

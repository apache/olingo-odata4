...
public class ODataJsonSerializer extends AbstractODataSerializer {
  ...
  protected void writeEntitySet(final ServiceMetadata metadata, final EdmEntityType entityType,
      final EntityCollection entitySet, final ContextURL contextURL, final ExpandOption expand,
  ...
  protected void writeEntity(final ServiceMetadata metadata, final EdmEntityType entityType,
      ...
      final SelectOption select, final boolean onlyReference, final boolean isTopEntity, final JsonGenerator json)
    ...
    if (property.isCollection()) {
      ...
      if (navigationLink == null || navigationLink.getInlineEntity() == null) {
        ...
        writeEntity(metadata, property.getType(), navigationLink.getInlineEntity(), contextURL,
            innerExpand, innerSelect, false, false, json);
      }
    }
  }

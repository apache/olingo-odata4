...
public class ODataXmlSerializer extends AbstractODataSerializer {
  ...
  private void writePrimitiveCollectionStreamed(final EdmPrimitiveType type, final PrimitiveIterator iterator,
          final Boolean isNullable, final Integer maxLength, final Integer precision, final Integer scale,
          final Boolean isUnicode, final String xml10InvalidCharReplacement,
          final XMLStreamWriter writer) throws XMLStreamException, EdmPrimitiveTypeException, SerializerException {
  ...
  public void primitiveCollectionIntoStream(final ServiceMetadata metadata, final EdmPrimitiveType type,
          final PrimitiveIterator iterator, final PrimitiveSerializerOptions options, final OutputStream outputStream)
          throws SerializerException {
    final ContextURL contextURL = checkContextURL(options == null ? null : options.getContextURL());
